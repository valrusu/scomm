...
func main() {
	...
	flag.BoolVar(&noFile1, "1", false, "discard lines only in FILE1, otherwise output them on file descriptor 5")
	flag.BoolVar(&noFile2, "2", false, "discard lines only in FILE2, otherwise output them on file descriptor 6")
